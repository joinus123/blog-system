...
<script type="text/javascript">
    ...
    function approve_post(post_id)
    {
       ...
       var ajax_request=null;
        ...
        ajax_request.open("POST","post_process.php");
        ajax_request.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        ajax_request.send("flag=approve_post&post_id="+post_id);
    }
     function unapprove_post(post_id)
    {
        //alert(post_id);
        //alert(user_id);
       var ajax_request=null;
        ...
        ajax_request.open("POST","post_process.php");
        ajax_request.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        ajax_request.send("flag=unapprove_post&post_id="+post_id);
    }
</script>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>DELETED</strong> &nbspPOSTS </h2>
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable" >
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            AND post_status.`status_id` = 5 ORDER BY blog_post.post_id DESC"; 
