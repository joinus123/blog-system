<?php
    ...
    if($_REQUEST['flag']=='approve_rejected_post')
	{
		...
		$query="UPDATE post_status SET post_status.`status_id`=3 WHERE post_status.`post_id` = '$post_id' AND post_status.status_id=6"; 
    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" >
        ...
        <tbody>
            ...
            <?php
                ...
                AND post_status.`status_id` = 6 ORDER BY blog_post.post_id DESC"; 
                $result=mysqli_query($connection,$query);
                if($result->num_rows)
                {   $c=1;
    ...
    {
        $post_id=$_REQUEST['post_id'];
       	$query="UPDATE post_status SET post_status.`status_id`=5 WHERE post_status.`post_id` = '$post_id' AND post_status.status_id=6"; 
        $result=mysqli_query($connection,$query);
        if($result)
        {
            ?>
