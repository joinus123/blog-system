...
<script type="text/javascript">
    ...
    function deactive_post(post_id)
    {
       ...
       var ajax_request=null;
        ...
        ajax_request.open("POST","post_process.php");
        ajax_request.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        ajax_request.send("flag=deactive_post&post_id="+post_id);
    }
    function delete_active_post(post_id)
    {
        //alert(post_id);
        //alert(user_id);
       var ajax_request=null;
        ...
        ajax_request.open("POST","post_process.php");
        ajax_request.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        ajax_request.send("flag=delete_active_post&post_id="+post_id);
    }
    function edit_active_post(post_id)
    {
       ...
       var ajax_request=null;
        ...
        ajax_request.open("POST","post_process.php");
        ajax_request.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        ajax_request.send("flag=edit_active_post&post_id="+post_id);
    }
</script>
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>ALL ACTIVE</strong> POSTS </h2>
