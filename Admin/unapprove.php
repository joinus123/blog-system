    ...
    function approve_rejected_post(post_id)
    {
       ...
       var ajax_request=null;
        ...
        ajax_request.onreadystatechange = function()
        {
            ...
            {
                //alert(ajax_request.responseText);
                document.getElementById("approve_rejected_post_response").innerHTML=ajax_request.responseText;
                //location.href = "index.php";
            }
        }
        ajax_request.open("POST","post_process.php");
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>UNAPPROVE</strong> POSTS </h2>
                        ...
                        <div class="body" id="approve_rejected_post_response">
