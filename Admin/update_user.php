        ...
        <div class="block-header">
            ...
            <div class="row clearfix">
                ...
                if(isset($_REQUEST['flag']))
                {
                    ...
                    $_SESSION['u_user_id']=$_REQUEST['user_id'];
                            ...
                            <form  action="include/profile_process.php"  method="POST" enctype="multipart/form-data" onsubmit="return form_validation()">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                       <center><button type="submit" class="btn btn-raised btn-primary btn-round waves-effect m-l-20" name="update_user" value="Update User">Update profile</button></center>         
                                    </div>
                                </div>
                            </form>
                            <?php
