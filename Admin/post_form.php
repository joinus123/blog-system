        ...
        ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <label style="font-size:16px;color:purple">Title</label>
                        <div class="body">
                    ...
                    <div class="card">
                        <label style="font-size:16px;color:purple">Category</label>
                        <div class="body">
                    ...
                    <div class="card">
                        <label style="font-size:16px;color:purple">Summary</label>
                        <div class="body">
                    ...
                    <div class="card">
                        <label style="font-size:16px;color:purple">Description</label>
                        <div class="body">
                   ...
                   <!--  <div class="card">
                     ...
                     <div class="card">
                        <label style="font-size:16px;color:purple">Total Attachment</label>
                        <div class="body">
