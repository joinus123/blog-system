    ...
    function email_varification()
        {
            ...
            ajax_request.open("POST","include/add_user_process.php");
        ...
        <div class="block-header">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">                
                    ...
                    <a href="view_users.php" class="btn btn-info btn-icon float-right"><i class="zmdi zmdi-check"></i></a>
                </div>
            </div>
        </div> 
     <?php
          ...
          ?>
            <div class="alert alert-success" role="alert">
              <div class="container">
                  ...
                  <div align="center"><strong>Well done!</strong> <?php echo $_GET['message'];?></div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header" align="center">
                            <h2><b style="font-size:30px"><strong>ADD</strong> USER</b></h2>
                        ...
                        <div class="body">
                            ...
                            <form  action="include/add_user_process.php"  method="POST" enctype="multipart/form-data" onsubmit="return form_validation()">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input style="color:black;" type="text" class="form-control" placeholder="Minimum one alphabet required" id="l_name" name="last_name" >
                                     ...
                                     <div class="col-lg-6 col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input style="color:black;" type="text" class="form-control" placeholder="0331-2477922" id="p_number" name="p_number" >
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-6">
                                        <div class="form-group">
                                            <label>CNIC</label>
                                            <input style="color:black;" type="text" class="form-control" placeholder="CNIC format: 44102-1234567-8" name="cnic" id="cnic" >
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input style="color:black;" type="text" class="form-control" placeholder="DOB format: 10-MARCH-1995" name="dob" id="dob" >
                                    ...
                                    <div class="col-lg-6 col-md-3 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input style="color:black;" type="text" class="form-control" placeholder="Minimum five digit/character/special-character" name="email" id="email" onblur="email_varification()"  >
                                  ...
                                  <div class="col-lg-6 col-md-3 col-sm-6">
                                      ...
                                      <div class="col-lg-6 col-md-3 col-sm-6">
                                            ...
                                            <div class="form-group"  style="border:1px solid lightgray;height:40px;padding:10px;border-radius:4px">
                                                ...
                                                <b style="margin-left:10%">
                                                    ...
                                                    <input type="radio"  name="gender[]" value="Female" id="female">     &nbsp&nbsp&nbsp&nbsp&nbsp&nbspFemale </b>
                                    ...
                                    <div class="col-lg-12 col-md-3 col-sm-12">
                                        <div class="form-group">
                                           ...
                                           <textarea style="color:black;" rows="4" class="form-control no-resize"  placeholder="Please enter your Home Town address..!" name="home_town" id="home_town"></textarea>
                                            <span id="home_town_msg" style="color:red"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-6 col-sm-12">
                                       <center><button type="submit" class="btn btn-raised btn-primary btn-round waves-effect m-l-20" name="add_user" value="Add User">Add User</button></center>         
                                    </div>
                                </div>
                            </form>
                        </div>
