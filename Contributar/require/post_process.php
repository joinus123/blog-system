...
if(isset($_REQUEST['flag']))
{
	if($_REQUEST['flag']=='total_attachment')
	{
		...
		for($i=1;$i<=$no_of_attachment;$i++)
		{
			?>
	        <div class="body">
	        	<label style="color:green;font-size:10">Select Attachment Type</label>
...
else if(isset($_REQUEST['update_pending_record']))
{
    extract($_POST);
   	$post_id;
   	$p_title;
